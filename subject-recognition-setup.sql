-- ============================================
-- SUBJECT RECOGNITION SYSTEM
-- ============================================
-- This creates a system for recognizing subjects and their variations/typos
-- Perfect for Class 10 CBSE and other educational contexts

-- ============================================
-- 1. SUBJECT MAPPINGS TABLE
-- ============================================
CREATE TABLE IF NOT EXISTS subject_mappings (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    canonical_name TEXT NOT NULL UNIQUE, -- The standardized subject name (e.g., "Social Studies")
    color TEXT NOT NULL DEFAULT '#3498db', -- Color for UI display
    class_level TEXT DEFAULT 'Class 10 CBSE', -- Which class/level this subject belongs to
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);

-- ============================================
-- 2. SUBJECT VARIATIONS TABLE
-- ============================================
CREATE TABLE IF NOT EXISTS subject_variations (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    subject_id UUID REFERENCES subject_mappings(id) ON DELETE CASCADE NOT NULL,
    variation TEXT NOT NULL UNIQUE, -- The variation/typo/abbreviation (e.g., "sst", "social", "s.st")
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
-- ============================================
-- These tables are read-only for everyone (public data)
...
-- ============================================
-- 6. HELPER FUNCTION to recognize subjects from text
-- ============================================
...
BEGIN
    ...
    ORDER BY LENGTH(sv.variation) DESC  -- Prefer longer matches (e.g., "computer science" over "computer")
    LIMIT 1;
END;
$$ LANGUAGE plpgsql;
...
DO $$
BEGIN
    RAISE NOTICE '✅ Subject Recognition System created successfully!';
    RAISE NOTICE '✅ All Class 10 CBSE subjects added';
    RAISE NOTICE '✅ Common typos and variations recognized';
